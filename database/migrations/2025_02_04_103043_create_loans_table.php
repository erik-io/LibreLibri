...
return new class extends Migration
{
     ...
     *
     * Diese Methode erstellt die `loans`-Tabelle mit den Spalten `id`, `transaction_id`, `copy_id`, `loan_date`, `due_date`, `return_date`, `status_id`, `created_at`, `updated_at` und `deleted_at`.
     * Zusätzlich werden mehrere Indizes für die Spalten `loan_date`, `due_date`, `return_date` und die Kombination `status_id` und `due_date` gesetzt.
     */
    public function up(): void
    {
        ...
        Schema::create('loans', function (Blueprint $table) {
            ...
            $table->foreignId('transaction_id')->constrained('loan_transactions'); // Fremdschlüssel auf `loan_transactions`
            ...
            $table->index(['status_id', 'due_date']); // Index auf Kombination von `status_id` und `due_date` für Überprüfung überfälliger Bücher
        });
    }
