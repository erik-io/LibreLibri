...
return new class extends Migration
{
     ...
     *
     * Diese Methode erstellt die `loan_history`-Tabelle mit den Spalten `id`, `loan_id`, `loan_status_id`, `comment`, `created_at` und `updated_at`.
     * Zusätzlich werden mehrere Indizes für die Spalten `created_at`, `loan_id`, `loan_status_id` und deren Kombinationen gesetzt.
     */
    public function up(): void
    {
        ...
        Schema::create('loan_history', function (Blueprint $table) {
            ...
            $table->index(['created_at', 'loan_status_id']); // Index auf Kombination von `created_at` und `loan_status_id` für Statistikabfragen
            ...
            $table->index(['loan_status_id', 'created_at']); // Index auf Kombination von `loan_status_id` und `created_at` für Statusänderungen in einem Zeitraum
        });
    }
